    ...
    def update_joints(self, command, velocity=False, blocking=False, cartesian_noise=None):
        ...
        def helper_non_blocking():
            if not self._robot.is_running_policy():
                ...
                # maybe here happens when we create two threads
                ...
                self._controller_not_loaded = False
            try:
                #maybe here we have the isue wth "ERROR:polymetis.robot_interface:Unable to update desired joint positions. Use 'start_joint_impedance' to start a joint impedance controller."
