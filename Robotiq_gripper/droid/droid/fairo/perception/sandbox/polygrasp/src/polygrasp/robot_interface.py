...
class GraspingRobotInterface(polymetis.RobotInterface):
    ...
    def gripper_open(self):
        ...
        #Changed made for franka hand
        #self.gripper.goto(width=self.gripper_max_width, speed=1, force=1)
    ...
    def gripper_close(self):
        ...
        #Changed made for Franka hand
        #self.gripper.grasp(speed=1, force=1, grasp_width=0.0, epsilon_inner=0.08, epsilon_outer=0.08)
